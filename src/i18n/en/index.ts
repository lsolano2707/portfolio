export default {
  ...
  aboutMe: {
    ...
    description:
      "I'm <strong>Leonardo Solano</strong> a <strong>full stack developer</strong> with <strong>over {years}+ years of experience</strong> in the software industry. I have had a lot of experience developing in different languages, mostly Java but in the last years, I have specialized in <strong>javaScript technologies</strong>. Currently living in Colombia, I'm really hoping to work with teams all over the world and learn about new technologies.",
  },
  profile: {
  ...
  skills: {
    ...
    items: {
      frontend: {
        ...
        description:
          'Other tools or technologies used: Quasar, Next js, Bootstrap, SASS, Axios, NPM, Yarn and among others.',
      },
      backend: {
        title: 'Back-End <span>Stack</span>',
        description:
          'Other tools or technologies used: Bun, REST, GraphQL, Redis, Kafka, Express, NPM, Yarn and among others.',
      },
      webServices: {
        title: 'Web Services <span>Stack</span>',
        description: 'Other tools or technologies used: SOAP.',
      },
      databases: {
        title: 'Databases <span>Stack</span>',
        description:
          'Other tools or technologies used: Mariadb, Sql Server, Dynamodb and among others.',
      },
      testing: {
      ...
      cloudPlatforms: {
        title: 'Cloud Platforms <span>Stack</span>',
        description:
          'Other tools or technologies used: Google Cloud, Azure and among others.',
      },
      others: {
        title: 'Others <span>Stack</span>',
        description:
          'Other tools or technologies used: Visual Studio Code, Postman, Photoshop, Canva, Microsoft Office and among others.',
      },
    },
  },
  languages: {
    ...
    items: [
      {
        ...
        endDate: 'Current',
        description:
          'Platform in development that seeks to reinforce the knowledge of all people who want to enter the world of programming.',
      ...
      },
      {
        ...
        startDate: 'Oct 2019',
        endDate: 'Nov 2019',
        description: 'Website of the largest gluten free store in Costa Rica.',
      ...
      },
      {
        ...
        startDate: 'Jun 2019',
        endDate: 'Oct 2019',
        description: 'English learn platform.',
        technologies: ['Angular', 'Bootstrap', 'Vercel'],
        responsibilities: [
          'Develop and maintenance of new releases using Angular.',
          'Define the structure and components for the project, making sure they are reusable.',
  ...
  brands: {
    title: 'Some <span>Brands</span>',
    description: 'Some of the brands with which I have collaborated',
    note: 'The urls lead to the official sites and do not represent the project I collaborated with',
  },
  education: {
    title: 'EDUCATION',
    items: [
